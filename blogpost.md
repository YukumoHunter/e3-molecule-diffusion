...
Our code is available in this repository and it is currently running. Below are some comparisons between PyTorch and JAX code snippets to illustrate the differences in implementation.
