...
# Histogram_cont
def histogram_cont_add(elements, num_bins=100, range=(0.0, 13.0), ignore_zeros=False):
    bins = [0] * num_bins
    for e in elements:
...
def histogram_cont_plot(
    num_bins=100, save_path=None, range=(0.0, 13.0), name="histogram"
):
    bins = [0] * num_bins
...
def histogram_cont_plot_both(
    hist_b, num_bins=100, save_path=None, wandb=None, name="histogram"
):
    bins = [0] * num_bins
